  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-teal-50 via-blue-50 to-cyan-50">
            ...
            <div className="space-y-6 mt-12">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+44 1949 829307</p>
                </div>
              </div>
      ...
      <div className="w-full max-w-6xl mx-auto h-64 md:h-80 lg:h-96 mb-15">
        <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2401.7556954438505!2d-0.9283272999999999!3d52.9887952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4879c90e044e09cf%3A0xd03bfefc8cded58!2sBelvoir%20Home%20Care%20Ltd!5e0!3m2!1sen!2slk!4v1763140090681!5m2!1sen!2slk"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
